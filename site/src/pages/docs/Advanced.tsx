      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="text-gray-400 mb-4">
            Cria uma instância pré-configurada com middlewares de cache, dedup, concurrency e
            logger.
          </p>
          <CodeBlock
            code={`const api = createProductionAtom({\n  baseUrl: 'https://api.acme.com'\n});`}
          />
        </section>
        ...
        <section>
          ...
          <p className="text-gray-400 mb-4">
            Você pode passar opções específicas para cada requisição, sobrescrevendo a instância
            global.
          </p>
          <CodeBlock
            code={`await api.get('/user', {\n  timeout: 2000,\n  headers: { 'X-Custom': 'Value' },\n  cache: false // Ignora o cache para esta chamada\n});`}
          />
        </section>
      </div>
    </div>

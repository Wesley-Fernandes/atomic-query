  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <p className="text-gray-400 text-lg leading-relaxed mb-8">
        Os middlewares são a espinha dorsal da Atomic Query. Eles permitem que você estenda as funcionalidades do motor de forma modular e segura.
      </p>
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-gray-400 mb-4">Injeta tokens de autenticação em todas as requisições automaticamente.</p>
        ...
        <section>
          ...
          <p className="text-gray-400 mb-4">Tenta novamente em caso de falha, com suporte a backoff exponencial.</p>
        ...
        <section>
          ...
          <p className="text-gray-400 mb-4">Garante que requisições de mutação venham de origens seguras.</p>
        ...
        <section className="bg-white/5 p-8 rounded-3xl border border-glass-border">
          ...
          <CodeBlock code={`api.use(async (ctx, next) => {

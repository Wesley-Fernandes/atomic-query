  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <p className="text-gray-400 text-lg leading-relaxed mb-8">
        A Atomic Query facilita o consumo de eventos do servidor (SSE), permitindo que você processe
        dados conforme eles chegam, sem precisar esperar o fechamento da conexão.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        <div className="glass p-6 rounded-2xl border-l-4 border-l-[#ff5f56]">
          ...
          <p className="text-sm text-gray-500">
            Perfeito para exibir respostas de chat (como GPT) caractere por caractere.
          </p>
        </div>
        <div className="glass p-6 rounded-2xl border-l-4 border-l-accent">
          ...
          <p className="text-sm text-gray-500">
            Proteção contra flood de memória com limite de 1MB por linha de stream.
          </p>
        </div>
      </div>
      ...
      <section className="bg-white/5 border border-glass-border p-8 rounded-3xl">
        ...
        <p className="text-gray-400 text-sm leading-relaxed">
          O SSE (Server-Sent Events) roda sobre HTTP convencional, o que significa que ele funciona
          nativamente com o cache da Atomic Query, é mais leve para o servidor e atravessa firewalls
          de forma muito mais simples que WebSockets.
        </p>
      </section>
    </div>
  );
